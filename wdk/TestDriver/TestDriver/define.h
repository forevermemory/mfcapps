...
typedef enum _PROCESSINFOCLASS
{
    ...
    ProcessDebugPort, // q: INT64, -1被调试 0没有被调试
    ...
    ProcessImageFileName, // q: [UINT64,UINT64,WCHAR...] +0x10
    ...
    ProcessImageFileNameWin32, // q: [UINT64,UINT64,WCHAR...] +0x10
...
#define STATUS_INFO_LENGTH_MISMATCH 0xC0000004
typedef DWORD(WINAPI* p_NtQueryInformationProcess)(IN HANDLE, IN PROCESSINFOCLASS, OUT PVOID, IN ULONG, OUT PULONG);
typedef DWORD(WINAPI* p_NtQuerySystemInformation)(IN SYSTEM_INFORMATION_CLASS, IN PVOID, IN ULONG, OUT PULONG);
typedef DWORD(WINAPI* p_NtQueryObject)(IN HANDLE, IN OBJECT_INFORMATION_CLASS, IN PVOID, IN ULONG, OUT PULONG);
